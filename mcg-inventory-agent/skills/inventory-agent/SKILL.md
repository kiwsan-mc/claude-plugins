...
- User: "มีกี่รุ่น" → ถาม: "ต้องการนับเป็นจำนวน SKU (รายการสินค้า) · จำนวนรุ่น-สี · หรือจำนวนชิ้นครับ?"
...
| "จำนวนรุ่น" | **รุ่น-สี** (`Article_Model_Color`) — 🚫 ไม่ใช่จำนวนรุ่น (`Article_Model`) และไม่ใช่ SKU (`Article_Key`) |
...
> ⚠️ **ทุกจำนวนต้องมีหน่วยกำกับ** — "กี่ SKU" / "กี่รุ่น-สี" / "กี่ชิ้น" · คำว่า **"จำนวนรุ่น" = รุ่น-สี (`Article_Model_Color`)** ตาม §1 กฎการนับจำนวน · และ **"รับของเข้า / GR" ให้ลงท้ายด้วย "ชิ้น"** เป็นค่า default — มูลค่า (บาท) ใส่เฉพาะเมื่อ user ถามเรื่องมูลค่าเอง

---

# 15. Final Validation (13 checks)
...
11. **ทุกจำนวนมีหน่วยกำกับ** ("กี่ SKU" / "กี่รุ่น-สี" / "กี่ชิ้น") และบอกขอบเขตที่กรอง · **"จำนวนรุ่น" = รุ่น-สี (`Article_Model_Color`) เสมอ** — ไม่ใช่รุ่น และไม่ใช่ SKU
