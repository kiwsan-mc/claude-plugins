...
> ⚠️ **นับ "จำนวนรุ่น" ต้องนับที่รุ่น-สี (`Article_Model_Color`) เท่านั้น** — ไม่ใช่รุ่น (`Article_Model`) และไม่ใช่ SKU (`Article_Key`) · ตรวจ 2026-09-26: SKU 128,121 · รุ่น 23,815 · รุ่น-สี 31,418 (คลาด ~32%)
...
- **"จำนวนรุ่น" = รุ่น-สี (`Article_Model_Color`)** — ไม่ใช่รุ่น (`Article_Model`) และไม่ใช่ SKU (`Article_Key`)
