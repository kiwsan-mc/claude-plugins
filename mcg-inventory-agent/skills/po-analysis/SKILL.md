...
> ℹ️ **กรณี 4 — ถ้าถาม "กี่รุ่น" ในมุมสินค้า ให้นับ "รุ่น-สี"** เป็นค่าเริ่มต้น และระบุหน่วยทุกครั้ง (SKU = `Article_Key` · รุ่น = `Article_Model`) · 🚫 ห้ามตอบ "จำนวนรุ่น" ด้วยจำนวน SKU หรือจำนวน Level4 โดยไม่บอกหน่วย
...
- 🔢 **ทุกคำตอบที่เป็นจำนวนต้องระบุหน่วยให้ชัด** — "จำนวนรุ่น" = **รุ่น-สี** เท่านั้น · 🚫 ไม่ใช่รุ่น และ 🚫 ไม่ใช่ SKU · ค่าจริง ณ 2026-09-26: SKU 128,121 · รุ่น 23,815 · **รุ่น-สี 31,418** (ต่างกัน ~32% ⇒ ผิดหน่วย = ตัวเลขผิดจริง)
...
- **Data Footer** — ใช้รูปแบบเดียวกับกฎกลาง (§13 ของ inventory-agent) ห้ามใส่ชื่อ table/tool/column:
  ...
  `📦 Data: Inventory | Snapshot/Period: [...] | As of: [max_date จาก anchor]`
