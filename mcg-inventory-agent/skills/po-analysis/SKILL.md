...
> ❓ ถ้าคำถามเป็น "จำนวน" ลอย ๆ ไม่ระบุหน่วย → ยึด qty (ชิ้น) เป็นตัวเลขหลัก **หรือถามกลับก่อน** ถ้าแยกไม่ได้ว่าหมายถึงชิ้น/ใบ/SKU/รุ่น-สี
...
- `CAST(... AS float)` ก่อน SUM/หาร · `APPROX_COUNT_DISTINCT` สำหรับนับ **SKU / รุ่น-สี (`Article_Model_Color`) / สาขา**
