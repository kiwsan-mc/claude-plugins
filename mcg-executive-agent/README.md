...
- ⚠️ **member / CRM metrics (Member%, Member ATV, Member Ticket%) และ Tickets / ATV / UPT ไม่มีในแหล่งข้อมูลของ agent นี้** → ส่งไป **mcg-sales-agent** (`member-analysis`, `sales-dashboard`)
