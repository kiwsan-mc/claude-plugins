...
`📊 Data: MC Group Overview | As of: Sales {max_sold_date} · Stock {max_stock_date} · Member/CRM {max_member_date}`
...
`📊 Data: MC Group Overview | Period: [...] | As of: Sales/Company/Stock {d1} · Member/CRM {d2}`
