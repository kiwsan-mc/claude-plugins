...
**v1.1.0** — คำถามถึงสมาชิก**รายคน**ที่ระบุรหัสลูกค้า (เช่น "ลูกค้า M2603-013482 มียอดซื้อเท่าไหร่"): exact match `Member_Code` แล้วสรุปยอดซื้อรายคน — ห้ามใช้ top members / LIKE — **พร้อมไต่ช่วงเวลา** (เดือน → FY → ทั้งตาราง) เพราะสมาชิกที่ซื้อครั้งสุดท้ายหลายเดือนก่อนจะไม่โผล่ในหน้าต่างเริ่มต้น
