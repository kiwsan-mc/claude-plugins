...
**ถ้าผู้ใช้ถามจำนวนโดยไม่ระบุหน่วย (เช่น "มีกี่รุ่น" / "ONE-PRICED มีกี่รุ่น") → ถามกลับก่อนว่าจะนับเป็น SKU / รุ่น-สี / ชิ้น** 🚫 ห้ามรัน SQL นี้แล้วตอบเอง · เมื่อยืนยันว่าเป็นรุ่น-สี (คำว่า "จำนวนรุ่น" = รุ่น-สี เท่านั้น) จึงรัน SQL นี้และตอบเป็น "X รุ่น-สี":
