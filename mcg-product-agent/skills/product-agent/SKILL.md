...
- ❌ "APPROX_COUNT_DISTINCT" → ✅ "นับจำนวน SKU"
...
> 🚫 **ห้ามถามกลับเมื่อผู้ใช้พิมพ์ "มีกี่รุ่น" / "จำนวนรุ่น" / "กี่รุ่น"** — คำว่า "รุ่น" ระบุหน่วยแล้ว (= รุ่น-สี) ⇒ **ตอบจำนวนรุ่น-สีทันที** · ถามกลับได้เฉพาะเมื่อไม่ระบุหน่วยจริง ("มีกี่ตัว" / "จำนวนเท่าไหร่") และควรถามเรื่อง **ขอบเขต** (ทั้งระบบ vs กรองแบรนด์/หมวด) มากกว่าถามซ้ำเรื่องหน่วย
